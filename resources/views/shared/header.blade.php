...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/style.css') }}?v=20260505-submit-orientation">
</head>
    ...
    <aside class="sidebar">
        ...
        <nav class="nav">
            ...
            <?php if ($role === 'student'): ?>
                ...
                <a class="nav-link <?= in_array($currentRoute, ['student.dashboard', 'student.profile'], true) ? 'active' : '' ?>" href="{{ route($studentLocked ? 'student.profile' : 'student.dashboard') }}"><svg viewBox="0 0 24 24"><path d="M12 3 2 8l10 5 8-4v6h2V8L12 3Zm-6 9v4c2 3 10 3 12 0v-4l-6 3-6-3Z"/></svg><span><?= $studentLocked ? 'Complete Profile' : 'Student Portal' ?></span></a>
            <?php endif; ?>
