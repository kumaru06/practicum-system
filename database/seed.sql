...
ON DUPLICATE KEY UPDATE name = VALUES(name), role = VALUES(role), is_active = VALUES(is_active), password_changed = VALUES(password_changed);
...
(5, 'BSMT', 'Bachelor of Science in Marine Transportation', 486, 1)
